...
//upload of school
Route::POST('/upload/schools', 'App\Http\Controllers\AdminController@storeSchool')->name('upload_schools');
Route::get('/edit_school/{school}', 'App\Http\ControllersAdminController@editSchool')->name('editSchool');
Route::put('/edit_school/{school}', 'App\Http\ControllersAdminController@updateSchool')->name('updateSchool');
Route::delete('/delete_school/{school}', 'App\Http\ControllersAdminController@deleteSchool')->name('deleteSchool');
Route::get('/schools', 'App\Http\ControllersAdminController@indexSchools')->name('indexSchools');

//upload of answer
Route::post('/upload/answers', 'App\Http\Controllers\AdminController@showAnswerForm')->name('showAnswerForm');
//challenge routes
Route::post('/manage/challenge', 'App\Http\Controllers\AdminController@setChallengeParameter')->name('manage_challenge');
Route::get('/edit-manage/challenge', 'App\Http\Controllers\AdminController@editChallenge');
Route::put('/update-manage/challenge', 'App\Http\Controllers\AdminController@updateChallenge');
Route::delete('/delete-manage/challenge', 'App\Http\Controllers\AdminController@deleteChallenge');
